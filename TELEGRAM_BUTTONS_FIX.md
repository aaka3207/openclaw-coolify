...
```bash
ssh netcup "docker exec <container-name> openclaw message send --channel telegram --target @yourusername --message 'Test buttons' --buttons '[[{\"text\":\"Yes\",\"callback_data\":\"yes\"}]]'"
```
...
```json
{
  ...
  "buttons": [
    [
      { "text": "📊 Dashboard", "url": "https://bot.appautomation.cloud" }
    ],
    [
