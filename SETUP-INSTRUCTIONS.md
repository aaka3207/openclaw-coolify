...
ssh netcup "docker exec <container-name> openclaw skills list"

# Check cron jobs
ssh netcup "docker exec <container-name> openclaw cron list"
...
ssh netcup "docker exec <container-name> openclaw cron run --name daily-health-check"
```
