...
**Usage:**
```bash
ssh netcup "docker exec <container-name> bash /app/scripts/test-deployment.sh"
```
...
```bash
# Backup config
ssh netcup "docker exec <container-name> cp /root/.openclaw/openclaw.json /root/.openclaw/openclaw.json.backup-before-optimization"
...
ssh netcup "docker exec <container-name> openclaw models status | grep google-antigravity | wc -l"
# Should show: 9
...
ssh netcup "docker exec <container-name> cp /root/.openclaw/openclaw.json.backup-before-optimization /root/.openclaw/openclaw.json"
